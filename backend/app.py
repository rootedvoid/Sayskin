...
def upload():
    ...
    try:
        ...
        # REMOVED: The early return statement that was preventing analysis
        # Step 4: Now continuing with full processing
...
if __name__ == "__main__":
    # Use the port provided by the environment or default to 5001
