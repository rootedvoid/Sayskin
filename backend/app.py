...
#         skin_type = prediction_skin("./static/image.png")
#         acne_type = prediction_acne("./static/image.png")
#         tone = identify_skin_tone("./static/image.png", dataset=skin_tone_dataset)
